...
## The Surrounding `Video Split Merge` Project Structure

This public repository (`duo-vision-recomposer/`) does not exist in a vacuum. It is a `View` inside a parent `Video Split Merge` project that has the standard structure:
...
└── Video Split Merge/
    ...
    └── Views/
        └── Public Repositories/
            ├── Duo-Vision Suite
            │   └── duo-vision-recomposer # This Public Repo
```
